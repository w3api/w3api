---
title: mmap.mmap.find
permalink: /Python/mmap/mmap/find/
date: 2021-01-01
key: Python.M.mmap.mmap.find
category: python
...
{% include w3api/datos.html clase=site.data.Python.M.mmap.mmap.metodos valor="find" %}
