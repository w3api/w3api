---
title: nntplib.NNTP.body
permalink: /Python/nntplib/NNTP/body/
date: 2021-01-01
key: Python.N.nntplib.NNTP.body
category: python
...
{% include w3api/datos.html clase=site.data.Python.N.nntplib.NNTP.metodos valor="body" %}
