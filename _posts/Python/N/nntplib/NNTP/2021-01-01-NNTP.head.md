---
title: nntplib.NNTP.head
permalink: /Python/nntplib/NNTP/head/
date: 2021-01-01
key: Python.N.nntplib.NNTP.head
category: python
...
{% include w3api/datos.html clase=site.data.Python.N.nntplib.NNTP.metodos valor="head" %}
