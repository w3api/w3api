...
permalink: /Python/logging/Logger/debug/
date: 2021-01-01
key: Python.L.logging.Logger.debug
category: python
...
{% include w3api/datos.html clase=site.data.Python.L.logging.Logger.metodos valor="debug" %}
