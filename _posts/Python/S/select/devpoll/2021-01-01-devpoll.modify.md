---
title: select.devpoll.modify
permalink: /Python/select/devpoll/modify/
date: 2021-01-01
key: Python.S.select.devpoll.modify
category: python
...
{% include w3api/datos.html clase=site.data.Python.S.select.devpoll.metodos valor="modify" %}
