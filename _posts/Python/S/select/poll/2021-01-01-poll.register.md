---
title: select.poll.register
permalink: /Python/select/poll/register/
date: 2021-01-01
key: Python.S.select.poll.register
category: python
...
{% include w3api/datos.html clase=site.data.Python.S.select.poll.metodos valor="register" %}
