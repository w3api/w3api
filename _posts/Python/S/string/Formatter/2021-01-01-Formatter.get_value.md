---
title: string.Formatter.get_value
permalink: /Python/string/Formatter/get_value/
date: 2021-01-01
key: Python.S.string.Formatter.get_value
category: python
...
{% include w3api/datos.html clase=site.data.Python.S.string.Formatter.metodos valor="get_value" %}
