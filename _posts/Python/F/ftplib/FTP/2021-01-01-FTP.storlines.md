---
title: ftplib.FTP.storlines
permalink: /Python/ftplib/FTP/storlines/
date: 2021-01-01
key: Python.F.ftplib.FTP.storlines
category: python
...
{% include w3api/datos.html clase=site.data.Python.F.ftplib.FTP.metodos valor="storlines" %}
