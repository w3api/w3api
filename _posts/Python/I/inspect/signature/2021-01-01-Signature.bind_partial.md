...
permalink: /Python/inspect/Signature/bind_partial/
date: 2021-01-01
key: Python.I.inspect.Signature.bind_partial
category: python
...
{% include w3api/datos.html clase=site.data.Python.I.inspect.Signature.metodos valor="bind_partial" %}
