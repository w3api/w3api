...
{% include w3api/datos.html clase=site.data.Java.J.JScrollPane.metodos valor="setVerticalScrollBar" %}
...
## Parámetros
* **JScrollBar verticalScrollBar**,  {% include w3api/param_description.html metodo=_dato parametro="JScrollBar verticalScrollBar" %}
