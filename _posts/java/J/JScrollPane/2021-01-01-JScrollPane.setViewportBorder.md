...
{% include w3api/datos.html clase=site.data.Java.J.JScrollPane.metodos valor="setViewportBorder" %}
...
## Parámetros
* **Border viewportBorder**,  {% include w3api/param_description.html metodo=_dato parametro="Border viewportBorder" %}
