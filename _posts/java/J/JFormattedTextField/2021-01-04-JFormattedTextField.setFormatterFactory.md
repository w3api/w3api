...
## Parámetros
* **JFormattedTextField.AbstractFormatterFactory tf**,  {% include w3api/param_description.html metodo=_data parametro="JFormattedTextField.AbstractFormatterFactory tf" %}
