---
title: JNLPRandomAccessFile.readInt()
permalink: Java/JNLPRandomAccessFile/readInt
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.J.JNLPRandomAccessFile.metodos valor="readInt" %}
