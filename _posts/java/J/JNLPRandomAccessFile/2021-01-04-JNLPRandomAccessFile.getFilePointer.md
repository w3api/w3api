---
title: JNLPRandomAccessFile.getFilePointer()
permalink: Java/JNLPRandomAccessFile/getFilePointer
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.J.JNLPRandomAccessFile.metodos valor="getFilePointer" %}
