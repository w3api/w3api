---
title: JNLPRandomAccessFile.writeBoolean()
permalink: Java/JNLPRandomAccessFile/writeBoolean
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.J.JNLPRandomAccessFile.metodos valor="writeBoolean" %}
