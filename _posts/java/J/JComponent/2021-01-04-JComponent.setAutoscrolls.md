---
title: JComponent.setAutoscrolls()
permalink: Java/JComponent/setAutoscrolls
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.J.JComponent.metodos valor="setAutoscrolls" %}
...
## Parámetros
* **boolean autoscrolls**,  {% include w3api/param_description.html metodo=_data parametro="boolean autoscrolls" %}
