...
{% include w3api/datos.html clase=site.data.Java.J.JPEGQTable.metodos valor="getScaledInstance" %}
...
## Parámetros
* **boolean forceBaseline**,  {% include w3api/param_description.html metodo=_dato parametro="boolean forceBaseline" %}
