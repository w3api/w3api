---
title: KeyEvent.getKeyText()
permalink: Java/KeyEvent-java-awt-event/getKeyText
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.K.KeyEvent-java-awt-event.metodos valor="getKeyText" %}
