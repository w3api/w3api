---
title: KeyEvent.VK_NUM_LOCK
permalink: Java/KeyEvent-java-awt-event/VK_NUM_LOCK
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.K.KeyEvent-java-awt-event.campos valor="VK_NUM_LOCK" %}
