---
title: BadKindHelper.read()
permalink: Java/BadKindHelper/read
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.B.BadKindHelper.metodos valor="read" %}
...
## Sintaxis
~~~java
public static BadKind read(InputStream istream)
~~~
