...
## Parámetros
* **Rectangle rowBounds**,  {% include w3api/param_description.html metodo=_data parametro="Rectangle rowBounds" %}
* **ListCellRenderer&lt;Object&gt; cellRenderer**,  {% include w3api/param_description.html metodo=_data parametro="ListCellRenderer<Object> cellRenderer" %}
...
* **ListSelectionModel selModel**,  {% include w3api/param_description.html metodo=_data parametro="ListSelectionModel selModel" %}
* **ListModel&lt;Object&gt; dataModel**,  {% include w3api/param_description.html metodo=_data parametro="ListModel<Object> dataModel" %}
* **int leadIndex**,  {% include w3api/param_description.html metodo=_data parametro="int leadIndex" %}
