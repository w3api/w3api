...
{% include w3api/datos.html clase=site.data.Java.B.BasicTreeUI.metodos valor="getPreferredSize" %}
...
## Parámetros
* **boolean checkConsistency**,  {% include w3api/param_description.html metodo=_dato parametro="boolean checkConsistency" %}
