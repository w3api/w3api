...
{% include w3api/datos.html clase=site.data.Java.B.BasicTabbedPaneUI.metodos valor="calculateTabHeight" %}
...
* **int fontHeight**,  {% include w3api/param_description.html metodo=_dato parametro="int fontHeight" %}
