...
{% include w3api/datos.html clase=site.data.Java.B.BeanContextServicesSupport.campos valor="bcsListeners" %}
...
## Sintaxis
~~~java
protected ArrayList<BeanContextServicesListener> bcsListeners
~~~
