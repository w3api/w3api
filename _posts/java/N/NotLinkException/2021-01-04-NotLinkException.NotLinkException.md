---
title: NotLinkException.NotLinkException()
...
{% include w3api/datos.html clase=site.data.Java.N.NotLinkException.constructores valor="NotLinkException" %}
...
## Clase Padre
[NotLinkException](/Java/NotLinkException/)
...
## Líneas de Código
<ul>
{%- for _ldc in site.data.Java.N.NotLinkException.ldc -%}
   <li>
