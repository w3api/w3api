---
title: Node.setDisable()
permalink: Java/Node-javafx-scene/setDisable
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.N.Node-javafx-scene.metodos valor="setDisable" %}
