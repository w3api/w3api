...
## Parámetros
* **EventContext source**,  {% include w3api/param_description.html metodo=_data parametro="EventContext source" %}
* **int type**,  {% include w3api/param_description.html metodo=_data parametro="int type" %}
* **Object changeInfo**,  {% include w3api/param_description.html metodo=_data parametro="Object changeInfo" %}
* **Binding oldBd**,  {% include w3api/param_description.html metodo=_data parametro="Binding oldBd" %}
* **Binding newBd**,  {% include w3api/param_description.html metodo=_data parametro="Binding newBd" %}
