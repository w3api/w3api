---
title: NotificationResult.getTargetedNotifications()
...
{% include w3api/datos.html clase=site.data.Java.N.NotificationResult.metodos valor="getTargetedNotifications" %}
