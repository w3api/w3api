---
title: NotFoundHelper.write()
permalink: /Java/NotFoundHelper/write/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.N.NotFoundHelper.metodos valor="write" %}
...
## Parámetros
* **NotFound value**,  {% include w3api/param_description.html metodo=_dato parametro="NotFound value" %}
