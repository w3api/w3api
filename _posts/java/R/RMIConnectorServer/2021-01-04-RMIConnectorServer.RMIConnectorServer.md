...
* **RMIServerImpl rmiServerImpl**,  {% include w3api/param_description.html metodo=_data parametro="RMIServerImpl rmiServerImpl" %}

## Excepciones
[IOException](/Java/IOException/), [MalformedURLException](/Java/MalformedURLException/), [IllegalArgumentException](/Java/IllegalArgumentException/)
