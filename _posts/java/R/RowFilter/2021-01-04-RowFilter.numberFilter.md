...
## Parámetros
* **RowFilter.ComparisonType type**,  {% include w3api/param_description.html metodo=_data parametro="RowFilter.ComparisonType type" %}
* **int... indices**,  {% include w3api/param_description.html metodo=_data parametro="int... indices" %}
* **Number number**,  {% include w3api/param_description.html metodo=_data parametro="Number number" %}
