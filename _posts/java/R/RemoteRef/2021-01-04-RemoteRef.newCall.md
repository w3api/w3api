...
## Parámetros
* **RemoteObject obj**,  {% include w3api/param_description.html metodo=_data parametro="RemoteObject obj" %}
...
* **Operation[] op**,  {% include w3api/param_description.html metodo=_data parametro="Operation[] op" %}
