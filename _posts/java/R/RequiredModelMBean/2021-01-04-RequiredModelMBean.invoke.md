...
## Parámetros
* **String[] sig**,  {% include w3api/param_description.html metodo=_data parametro="String[] sig" %}
* **String opName**,  {% include w3api/param_description.html metodo=_data parametro="String opName" %}
* **Object[] opArgs**,  {% include w3api/param_description.html metodo=_data parametro="Object[] opArgs" %}
