...
permalink: Java/RelationService/checkRoleWriting
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.R.RelationService.metodos valor="checkRoleWriting" %}
...
* **Boolean initFlag**,  {% include w3api/param_description.html metodo=_data parametro="Boolean initFlag" %}
