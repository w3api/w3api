---
title: ReplicateScaleFilter.setPixels()
permalink: Java/ReplicateScaleFilter/setPixels
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.R.ReplicateScaleFilter.metodos valor="setPixels" %}
