---
title: RMIConnectionImpl.RMIConnectionImpl()
permalink: Java/RMIConnectionImpl/RMIConnectionImpl
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.RMIConnectionImpl.constructores valor="RMIConnectionImpl" %}
...
## Parámetros
* **ClassLoader defaultClassLoader**,  {% include w3api/param_description.html metodo=_dato parametro="ClassLoader defaultClassLoader" %}
* **RMIServerImpl rmiServer**,  {% include w3api/param_description.html metodo=_dato parametro="RMIServerImpl rmiServer" %}
...
## Clase Padre
[RMIConnectionImpl](/Java/RMIConnectionImpl/)
