---
title: Rectangle2D.intersects()
permalink: Java/Rectangle2D-javafx-geometry/intersects
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.Rectangle2D-javafx-geometry.metodos valor="intersects" %}
