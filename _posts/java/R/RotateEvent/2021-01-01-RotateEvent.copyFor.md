---
title: RotateEvent.copyFor()
permalink: Java/RotateEvent/copyFor
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.RotateEvent.metodos valor="copyFor" %}
...
## Parámetros
* **EventType&lt;RotateEvent&gt; type**,  {% include w3api/param_description.html metodo=_dato parametro="EventType<RotateEvent> type" %}
