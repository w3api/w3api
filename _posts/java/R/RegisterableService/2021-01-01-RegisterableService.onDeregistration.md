---
title: RegisterableService.onDeregistration()
permalink: /Java/RegisterableService/onDeregistration/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.RegisterableService.metodos valor="onDeregistration" %}
