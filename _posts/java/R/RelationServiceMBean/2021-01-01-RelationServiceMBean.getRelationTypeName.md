...
permalink: /Java/RelationServiceMBean/getRelationTypeName/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.RelationServiceMBean.metodos valor="getRelationTypeName" %}
