---
title: RecordedObject.getThread()
permalink: Java/RecordedObject/getThread
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.RecordedObject.metodos valor="getThread" %}
