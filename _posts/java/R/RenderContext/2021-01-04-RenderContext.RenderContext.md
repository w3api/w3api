...
## Parámetros
* **Shape aoi**,  {% include w3api/param_description.html metodo=_data parametro="Shape aoi" %}
* **RenderingHints hints**,  {% include w3api/param_description.html metodo=_data parametro="RenderingHints hints" %}
* **AffineTransform usr2dev**,  {% include w3api/param_description.html metodo=_data parametro="AffineTransform usr2dev" %}
