---
title: Rectangle.setArcWidth()
permalink: Java/Rectangle-javafx-scene-shape/setArcWidth
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.Rectangle-javafx-scene-shape.metodos valor="setArcWidth" %}
