---
title: Rectangle.setArcHeight()
permalink: Java/Rectangle-javafx-scene-shape/setArcHeight
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.Rectangle-javafx-scene-shape.metodos valor="setArcHeight" %}
