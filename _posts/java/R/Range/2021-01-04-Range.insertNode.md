...
permalink: Java/Range/insertNode
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.R.Range.metodos valor="insertNode" %}
...
## Parámetros
* **Node newNode**,  {% include w3api/param_description.html metodo=_data parametro="Node newNode" %}
