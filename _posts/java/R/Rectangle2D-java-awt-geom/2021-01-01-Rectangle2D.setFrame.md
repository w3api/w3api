---
title: Rectangle2D.setFrame()
permalink: Java/Rectangle2D-java-awt-geom/setFrame
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.Rectangle2D-java-awt-geom.metodos valor="setFrame" %}
