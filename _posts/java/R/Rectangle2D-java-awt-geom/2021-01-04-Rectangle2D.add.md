...
## Parámetros
* **double newx**,  {% include w3api/param_description.html metodo=_data parametro="double newx" %}
* **Point2D pt**,  {% include w3api/param_description.html metodo=_data parametro="Point2D pt" %}
* **double newy**,  {% include w3api/param_description.html metodo=_data parametro="double newy" %}
