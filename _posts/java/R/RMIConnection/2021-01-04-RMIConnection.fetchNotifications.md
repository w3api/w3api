...
## Parámetros
* **int maxNotifications**,  {% include w3api/param_description.html metodo=_data parametro="int maxNotifications" %}
* **long timeout**,  {% include w3api/param_description.html metodo=_data parametro="long timeout" %}
* **long clientSequenceNumber**,  {% include w3api/param_description.html metodo=_data parametro="long clientSequenceNumber" %}
