---
title: RMIConnection.queryMBeans()
permalink: Java/RMIConnection/queryMBeans
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.R.RMIConnection.metodos valor="queryMBeans" %}
...
## Parámetros
* **MarshalledObject query**,  {% include w3api/param_description.html metodo=_data parametro="MarshalledObject query" %}
