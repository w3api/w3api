---
title: XMLEventFactory.createCData()
permalink: Java/XMLEventFactory/createCData
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.X.XMLEventFactory.metodos valor="createCData" %}
