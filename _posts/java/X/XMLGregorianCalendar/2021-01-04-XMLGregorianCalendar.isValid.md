---
title: XMLGregorianCalendar.isValid()
permalink: Java/XMLGregorianCalendar/isValid
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.X.XMLGregorianCalendar.metodos valor="isValid" %}
