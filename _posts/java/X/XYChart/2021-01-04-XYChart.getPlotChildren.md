---
title: XYChart.getPlotChildren()
permalink: Java/XYChart/getPlotChildren
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.X.XYChart.metodos valor="getPlotChildren" %}
