---
title: XYChart.setHorizontalGridLinesVisible()
permalink: Java/XYChart/setHorizontalGridLinesVisible
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.X.XYChart.metodos valor="setHorizontalGridLinesVisible" %}
