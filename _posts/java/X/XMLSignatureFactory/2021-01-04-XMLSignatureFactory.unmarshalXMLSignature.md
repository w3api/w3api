...
## Parámetros
* **XMLValidateContext context**,  {% include w3api/param_description.html metodo=_data parametro="XMLValidateContext context" %}
* **XMLStructure xmlStructure**,  {% include w3api/param_description.html metodo=_data parametro="XMLStructure xmlStructure" %}
