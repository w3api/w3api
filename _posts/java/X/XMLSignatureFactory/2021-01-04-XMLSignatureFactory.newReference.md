...
## Parámetros
* **Data result**,  {% include w3api/param_description.html metodo=_data parametro="Data result" %}
* **String type**,  {% include w3api/param_description.html metodo=_data parametro="String type" %}
* **DigestMethod dm**,  {% include w3api/param_description.html metodo=_data parametro="DigestMethod dm" %}
...
* **List&lt;? extends Transform&gt; appliedTransforms**,  {% include w3api/param_description.html metodo=_data parametro="List<? extends Transform> appliedTransforms" %}
* **byte[] digestValue**,  {% include w3api/param_description.html metodo=_data parametro="byte[] digestValue" %}
