---
title: XMLReaderAdapter.startPrefixMapping()
permalink: Java/XMLReaderAdapter/startPrefixMapping
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.X.XMLReaderAdapter.metodos valor="startPrefixMapping" %}
