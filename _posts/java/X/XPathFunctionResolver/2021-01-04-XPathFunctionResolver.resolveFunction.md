...
## Parámetros
* **int arity**,  {% include w3api/param_description.html metodo=_data parametro="int arity" %}
* **QName functionName**,  {% include w3api/param_description.html metodo=_data parametro="QName functionName" %}
