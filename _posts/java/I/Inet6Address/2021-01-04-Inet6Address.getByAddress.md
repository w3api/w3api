...
* **int scope_id**,  {% include w3api/param_description.html metodo=_data parametro="int scope_id" %}
* **NetworkInterface nif**,  {% include w3api/param_description.html metodo=_data parametro="NetworkInterface nif" %}
