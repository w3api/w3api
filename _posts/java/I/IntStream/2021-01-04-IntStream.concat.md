...
## Parámetros
* **IntStream b**,  {% include w3api/param_description.html metodo=_data parametro="IntStream b" %}
* **IntStream a**,  {% include w3api/param_description.html metodo=_data parametro="IntStream a" %}
