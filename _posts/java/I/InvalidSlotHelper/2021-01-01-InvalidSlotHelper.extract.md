---
title: InvalidSlotHelper.extract()
permalink: Java/InvalidSlotHelper/extract
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.I.InvalidSlotHelper.metodos valor="extract" %}
