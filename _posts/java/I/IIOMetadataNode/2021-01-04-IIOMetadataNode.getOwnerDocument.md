---
title: IIOMetadataNode.getOwnerDocument()
permalink: Java/IIOMetadataNode/getOwnerDocument
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.I.IIOMetadataNode.metodos valor="getOwnerDocument" %}
