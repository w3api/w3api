---
title: IIOMetadataFormat.getChildPolicy()
permalink: Java/IIOMetadataFormat/getChildPolicy
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.I.IIOMetadataFormat.metodos valor="getChildPolicy" %}
