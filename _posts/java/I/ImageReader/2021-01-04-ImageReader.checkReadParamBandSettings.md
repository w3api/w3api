...
* **int numSrcBands**,  {% include w3api/param_description.html metodo=_data parametro="int numSrcBands" %}
* **int numDstBands**,  {% include w3api/param_description.html metodo=_data parametro="int numDstBands" %}
