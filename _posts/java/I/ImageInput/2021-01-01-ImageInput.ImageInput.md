---
title: ImageInput.ImageInput()
permalink: Java/ImageInput/ImageInput
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.I.ImageInput.constructores valor="ImageInput" %}
...
* **Image source**,  {% include w3api/param_description.html metodo=_dato parametro="Image source" %}
* **double y**,  {% include w3api/param_description.html metodo=_dato parametro="double y" %}

## Clase Padre
[ImageInput](/Java/ImageInput/)
