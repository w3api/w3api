...
{% include w3api/datos.html clase=site.data.Java.I.IDLTypeHelper.metodos valor="insert" %}
...
* **IDLType that**,  {% include w3api/param_description.html metodo=_dato parametro="IDLType that" %}
