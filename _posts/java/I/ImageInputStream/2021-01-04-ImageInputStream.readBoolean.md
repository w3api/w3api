---
title: ImageInputStream.readBoolean()
permalink: Java/ImageInputStream/readBoolean
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.I.ImageInputStream.metodos valor="readBoolean" %}
