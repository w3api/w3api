---
title: ImageInputStream.readFloat()
permalink: Java/ImageInputStream/readFloat
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.I.ImageInputStream.metodos valor="readFloat" %}
