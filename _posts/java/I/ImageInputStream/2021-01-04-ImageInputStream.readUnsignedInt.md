---
title: ImageInputStream.readUnsignedInt()
permalink: Java/ImageInputStream/readUnsignedInt
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.I.ImageInputStream.metodos valor="readUnsignedInt" %}
