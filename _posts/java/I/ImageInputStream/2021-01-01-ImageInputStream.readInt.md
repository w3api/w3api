---
title: ImageInputStream.readInt()
permalink: Java/ImageInputStream/readInt
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.I.ImageInputStream.metodos valor="readInt" %}
