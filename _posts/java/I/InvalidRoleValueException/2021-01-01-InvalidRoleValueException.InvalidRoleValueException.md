...
{% include w3api/datos.html clase=site.data.Java.I.InvalidRoleValueException.constructores valor="InvalidRoleValueException" %}
...
## Clase Padre
[InvalidRoleValueException](/Java/InvalidRoleValueException/)
