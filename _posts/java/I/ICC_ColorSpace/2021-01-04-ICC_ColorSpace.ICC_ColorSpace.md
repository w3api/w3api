...
{% include w3api/datos.html clase=site.data.Java.I.ICC_ColorSpace.constructores valor="ICC_ColorSpace" %}
...
## Parámetros
* **ICC_Profile profile**,  {% include w3api/param_description.html metodo=_data parametro="ICC_Profile profile" %}
