---
title: _DynFixedStub.get_boolean()
permalink: Java/_DynFixedStub/get_boolean
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java._._DynFixedStub.metodos valor="get_boolean" %}
