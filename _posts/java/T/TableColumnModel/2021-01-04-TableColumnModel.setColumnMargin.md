...
{% include w3api/datos.html clase=site.data.Java.T.TableColumnModel.metodos valor="setColumnMargin" %}
...
## Parámetros
* **int newMargin**,  {% include w3api/param_description.html metodo=_data parametro="int newMargin" %}
