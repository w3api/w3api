...
{% include w3api/datos.html clase=site.data.Java.T.ThaiBuddhistChronology.metodos valor="isLeapYear" %}
...
## Parámetros
* **long prolepticYear**,  {% include w3api/param_description.html metodo=_data parametro="long prolepticYear" %}
