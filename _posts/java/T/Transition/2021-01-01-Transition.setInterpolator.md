...
{% include w3api/datos.html clase=site.data.Java.T.Transition.metodos valor="setInterpolator" %}
...
## Parámetros
* **Interpolator value**,  {% include w3api/param_description.html metodo=_dato parametro="Interpolator value" %}
