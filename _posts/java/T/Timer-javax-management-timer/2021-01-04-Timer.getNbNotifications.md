---
title: Timer.getNbNotifications()
permalink: Java/Timer-javax-management-timer/getNbNotifications
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.Timer-javax-management-timer.metodos valor="getNbNotifications" %}
