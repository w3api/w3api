...
{% include w3api/datos.html clase=site.data.Java.T.TypeMismatch-org-omg-DynamicAny-DynAnyPackage.constructores valor="TypeMismatch" %}
...
## Clase Padre
[TypeMismatch](/Java/TypeMismatch-org-omg-DynamicAny-DynAnyPackage/)
