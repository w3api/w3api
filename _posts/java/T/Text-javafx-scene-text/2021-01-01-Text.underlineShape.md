---
title: Text.underlineShape()
permalink: /Java/Text-javafx-scene-text/underlineShape/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.T.Text-javafx-scene-text.metodos valor="underlineShape" %}
