---
title: TableView.resizeColumn()
permalink: Java/TableView-javafx-scene-control/resizeColumn
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TableView-javafx-scene-control.metodos valor="resizeColumn" %}
...
* **double delta**,  {% include w3api/param_description.html metodo=_data parametro="double delta" %}
