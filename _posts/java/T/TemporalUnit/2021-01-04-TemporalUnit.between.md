...
## Parámetros
* **Temporal temporal2Exclusive**,  {% include w3api/param_description.html metodo=_data parametro="Temporal temporal2Exclusive" %}
* **Temporal temporal1Inclusive**,  {% include w3api/param_description.html metodo=_data parametro="Temporal temporal1Inclusive" %}
