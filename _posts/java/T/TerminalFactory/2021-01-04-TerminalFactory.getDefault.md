---
title: TerminalFactory.getDefault()
permalink: Java/TerminalFactory/getDefault
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TerminalFactory.metodos valor="getDefault" %}
