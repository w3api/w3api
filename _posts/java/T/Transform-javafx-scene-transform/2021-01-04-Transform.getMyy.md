---
title: Transform.getMyy()
permalink: Java/Transform-javafx-scene-transform/getMyy
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.Transform-javafx-scene-transform.metodos valor="getMyy" %}
