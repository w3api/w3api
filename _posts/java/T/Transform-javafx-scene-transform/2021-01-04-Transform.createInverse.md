---
title: Transform.createInverse()
permalink: Java/Transform-javafx-scene-transform/createInverse
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.Transform-javafx-scene-transform.metodos valor="createInverse" %}
