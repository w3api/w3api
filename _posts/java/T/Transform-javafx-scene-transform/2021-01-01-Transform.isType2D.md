---
title: Transform.isType2D()
permalink: Java/Transform-javafx-scene-transform/isType2D
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.T.Transform-javafx-scene-transform.metodos valor="isType2D" %}
