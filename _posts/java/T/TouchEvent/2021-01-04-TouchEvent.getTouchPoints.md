---
title: TouchEvent.getTouchPoints()
permalink: Java/TouchEvent/getTouchPoints
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TouchEvent.metodos valor="getTouchPoints" %}
