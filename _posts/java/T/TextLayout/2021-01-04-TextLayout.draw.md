---
title: TextLayout.draw()
permalink: Java/TextLayout/draw
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TextLayout.metodos valor="draw" %}
...
* **Graphics2D g2**,  {% include w3api/param_description.html metodo=_data parametro="Graphics2D g2" %}
