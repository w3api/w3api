...
permalink: /Java/ThreadMXBean-java-lang-management/isCurrentThreadCpuTimeSupported/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.T.ThreadMXBean-java-lang-management.metodos valor="isCurrentThreadCpuTimeSupported" %}
