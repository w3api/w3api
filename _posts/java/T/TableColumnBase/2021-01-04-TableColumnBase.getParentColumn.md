---
title: TableColumnBase.getParentColumn()
permalink: Java/TableColumnBase/getParentColumn
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TableColumnBase.metodos valor="getParentColumn" %}
