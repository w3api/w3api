---
title: ThreadGroup.allowThreadSuspension()
permalink: Java/ThreadGroup/allowThreadSuspension
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.ThreadGroup.metodos valor="allowThreadSuspension" %}
