---
title: TreeVisitor.visitSwitch()
permalink: Java/TreeVisitor-com-sun-source-tree/visitSwitch
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TreeVisitor-com-sun-source-tree.metodos valor="visitSwitch" %}
...
* **SwitchTree node**,  {% include w3api/param_description.html metodo=_data parametro="SwitchTree node" %}
