---
title: TreeVisitor.visitImport()
permalink: Java/TreeVisitor-com-sun-source-tree/visitImport
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TreeVisitor-com-sun-source-tree.metodos valor="visitImport" %}
...
## Parámetros
* **ImportTree node**,  {% include w3api/param_description.html metodo=_data parametro="ImportTree node" %}
