---
title: TreeVisitor.visitAssert()
permalink: Java/TreeVisitor-com-sun-source-tree/visitAssert
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.T.TreeVisitor-com-sun-source-tree.metodos valor="visitAssert" %}
...
* **AssertTree node**,  {% include w3api/param_description.html metodo=_data parametro="AssertTree node" %}
