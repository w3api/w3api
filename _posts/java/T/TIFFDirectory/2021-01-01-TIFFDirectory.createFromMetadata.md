...
## Parámetros
* **IIOMetadata tiffImageMetadata**,  {% include w3api/param_description.html metodo=_dato parametro="IIOMetadata tiffImageMetadata" %}

## Excepciones
[IllegalArgumentException](/Java/IllegalArgumentException/), [IIOInvalidTreeException](/Java/IIOInvalidTreeException/), [NullPointerException](/Java/NullPointerException/)
