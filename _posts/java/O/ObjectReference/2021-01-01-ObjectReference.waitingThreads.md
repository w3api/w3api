---
title: ObjectReference.waitingThreads()
permalink: Java/ObjectReference/waitingThreads
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.O.ObjectReference.metodos valor="waitingThreads" %}
