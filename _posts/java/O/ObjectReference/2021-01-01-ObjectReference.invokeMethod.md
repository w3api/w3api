---
title: ObjectReference.invokeMethod()
permalink: Java/ObjectReference/invokeMethod
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.O.ObjectReference.metodos valor="invokeMethod" %}
