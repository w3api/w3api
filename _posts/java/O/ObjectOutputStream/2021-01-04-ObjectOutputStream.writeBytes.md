---
title: ObjectOutputStream.writeBytes()
permalink: Java/ObjectOutputStream/writeBytes
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.O.ObjectOutputStream.metodos valor="writeBytes" %}
