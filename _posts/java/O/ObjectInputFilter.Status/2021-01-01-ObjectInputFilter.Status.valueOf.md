...
{% include w3api/datos.html clase=site.data.Java.O.ObjectInputFilter.Status.metodos valor="valueOf" %}
...
## Sintaxis
~~~java
public static ObjectInputFilter.Status valueOf(String name)
~~~
