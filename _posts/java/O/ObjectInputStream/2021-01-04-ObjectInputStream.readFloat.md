---
title: ObjectInputStream.readFloat()
permalink: Java/ObjectInputStream/readFloat
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.O.ObjectInputStream.metodos valor="readFloat" %}
