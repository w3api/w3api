...
{% include w3api/datos.html clase=site.data.Java.O.ObjectReferenceFactoryHelper.metodos valor="read" %}
...
## Sintaxis
~~~java
public static ObjectReferenceFactory read(InputStream istream)
~~~
