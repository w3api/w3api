...
{% include w3api/datos.html clase=site.data.Java.O.ORBInitInfoOperations.metodos valor="register_policy_factory" %}
...
* **PolicyFactory policy_factory**,  {% include w3api/param_description.html metodo=_data parametro="PolicyFactory policy_factory" %}
