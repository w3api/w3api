---
title: ForwardingFileObject.openInputStream()
permalink: Java/ForwardingFileObject/openInputStream
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.F.ForwardingFileObject.metodos valor="openInputStream" %}
