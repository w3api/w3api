---
title: ForwardingFileObject.openOutputStream()
permalink: Java/ForwardingFileObject/openOutputStream
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.F.ForwardingFileObject.metodos valor="openOutputStream" %}
