...
{% include w3api/datos.html clase=site.data.Java.F.FileTypeMap.metodos valor="setDefaultFileTypeMap" %}
...
## Parámetros
* **FileTypeMap fileTypeMap**,  {% include w3api/param_description.html metodo=_data parametro="FileTypeMap fileTypeMap" %}
