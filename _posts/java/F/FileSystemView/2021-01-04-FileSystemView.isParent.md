---
title: FileSystemView.isParent()
permalink: Java/FileSystemView/isParent
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.F.FileSystemView.metodos valor="isParent" %}
...
## Parámetros
* **File folder**,  {% include w3api/param_description.html metodo=_data parametro="File folder" %}
