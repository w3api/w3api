...
## Parámetros
* **Frame parent**,  {% include w3api/param_description.html metodo=_data parametro="Frame parent" %}
* **String title**,  {% include w3api/param_description.html metodo=_data parametro="String title" %}
* **Dialog parent**,  {% include w3api/param_description.html metodo=_data parametro="Dialog parent" %}
