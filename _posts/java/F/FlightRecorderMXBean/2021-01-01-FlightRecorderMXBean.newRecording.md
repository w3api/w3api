---
title: FlightRecorderMXBean.newRecording()
permalink: Java/FlightRecorderMXBean/newRecording
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.F.FlightRecorderMXBean.metodos valor="newRecording" %}
