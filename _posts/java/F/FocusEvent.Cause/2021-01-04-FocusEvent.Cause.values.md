---
title: FocusEvent.Cause.values()
permalink: Java/FocusEvent/Cause/values
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.F.FocusEvent.Cause.metodos valor="values" %}
