...
## Parámetros
* **ObservableList&lt;E&gt; source**,  {% include w3api/param_description.html metodo=_data parametro="ObservableList<E> source" %}
* **Predicate&lt;? super E&gt; predicate**,  {% include w3api/param_description.html metodo=_data parametro="Predicate<? super E> predicate" %}
