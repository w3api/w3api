---
title: EventRequestManager.vmDeathRequests()
permalink: Java/EventRequestManager/vmDeathRequests
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.E.EventRequestManager.metodos valor="vmDeathRequests" %}
