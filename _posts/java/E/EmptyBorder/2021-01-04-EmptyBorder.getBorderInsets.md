---
title: EmptyBorder.getBorderInsets()
permalink: Java/EmptyBorder/getBorderInsets
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.E.EmptyBorder.metodos valor="getBorderInsets" %}
...
## Líneas de Código
<ul>
{%- for _ldc in site.data.Java.E.EmptyBorder.ldc -%}
   <li>
