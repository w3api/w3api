...
{% include w3api/datos.html clase=site.data.Java.A.Authenticator-java-net.metodos valor="setDefault" %}
...
## Parámetros
* **Authenticator a**,  {% include w3api/param_description.html metodo=_dato parametro="Authenticator a" %}
