---
title: AbstractTableModel.getColumnName()
permalink: Java/AbstractTableModel/getColumnName
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.A.AbstractTableModel.metodos valor="getColumnName" %}
