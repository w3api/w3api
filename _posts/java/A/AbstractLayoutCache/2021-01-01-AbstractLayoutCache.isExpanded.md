---
title: AbstractLayoutCache.isExpanded()
permalink: Java/AbstractLayoutCache/isExpanded
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.A.AbstractLayoutCache.metodos valor="isExpanded" %}
