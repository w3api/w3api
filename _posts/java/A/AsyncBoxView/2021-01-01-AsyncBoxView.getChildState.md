---
title: AsyncBoxView.getChildState()
permalink: Java/AsyncBoxView/getChildState
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.A.AsyncBoxView.metodos valor="getChildState" %}
