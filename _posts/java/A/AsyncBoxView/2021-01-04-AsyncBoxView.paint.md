---
title: AsyncBoxView.paint()
permalink: Java/AsyncBoxView/paint
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.A.AsyncBoxView.metodos valor="paint" %}
...
## Parámetros
* **Shape alloc**,  {% include w3api/param_description.html metodo=_data parametro="Shape alloc" %}
