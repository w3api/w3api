---
title: AbstractPreferences.get()
permalink: Java/AbstractPreferences/get
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.A.AbstractPreferences.metodos valor="get" %}
...
## Parámetros
* **String def**,  {% include w3api/param_description.html metodo=_data parametro="String def" %}
