---
title: AbstractRegionPainter.decodeAnchorY()
permalink: Java/AbstractRegionPainter/decodeAnchorY
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.A.AbstractRegionPainter.metodos valor="decodeAnchorY" %}
...
* **float dy**,  {% include w3api/param_description.html metodo=_dato parametro="float dy" %}
