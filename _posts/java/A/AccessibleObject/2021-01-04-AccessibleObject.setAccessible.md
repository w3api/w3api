...
* **AccessibleObject[] array**,  {% include w3api/param_description.html metodo=_data parametro="AccessibleObject[] array" %}

## Excepciones
[InaccessibleObjectException](/Java/InaccessibleObjectException/), [SecurityException](/Java/SecurityException/)
