---
title: PerspectiveTransform.setUry()
permalink: Java/PerspectiveTransform/setUry
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.P.PerspectiveTransform.metodos valor="setUry" %}
