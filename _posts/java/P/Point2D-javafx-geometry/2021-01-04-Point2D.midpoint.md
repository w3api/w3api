---
title: Point2D.midpoint()
permalink: Java/Point2D-javafx-geometry/midpoint
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.P.Point2D-javafx-geometry.metodos valor="midpoint" %}
