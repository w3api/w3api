...
* **POAManager a_POAManager**,  {% include w3api/param_description.html metodo=_data parametro="POAManager a_POAManager" %}
* **String adapter_name**,  {% include w3api/param_description.html metodo=_data parametro="String adapter_name" %}
