...
{% include w3api/datos.html clase=site.data.Java.P.PopupFeatures.constructores valor="PopupFeatures" %}
...
## Parámetros
* **boolean status**,  {% include w3api/param_description.html metodo=_data parametro="boolean status" %}
...
* **boolean toolbar**,  {% include w3api/param_description.html metodo=_data parametro="boolean toolbar" %}

## Clase Padre
[PopupFeatures](/Java/PopupFeatures/)
