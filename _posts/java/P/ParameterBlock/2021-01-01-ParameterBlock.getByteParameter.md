---
title: ParameterBlock.getByteParameter()
permalink: Java/ParameterBlock/getByteParameter
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.P.ParameterBlock.metodos valor="getByteParameter" %}
