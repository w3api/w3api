...
* **float x3**,  {% include w3api/param_description.html metodo=_dato parametro="float x3" %}
* **double x2**,  {% include w3api/param_description.html metodo=_dato parametro="double x2" %}
* **float y3**,  {% include w3api/param_description.html metodo=_dato parametro="float y3" %}
