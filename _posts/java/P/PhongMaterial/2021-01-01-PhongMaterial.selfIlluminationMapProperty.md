---
title: PhongMaterial.selfIlluminationMapProperty()
...
{% include w3api/datos.html clase=site.data.Java.P.PhongMaterial.metodos valor="selfIlluminationMapProperty" %}
