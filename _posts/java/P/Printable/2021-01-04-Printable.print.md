...
* **Graphics graphics**,  {% include w3api/param_description.html metodo=_data parametro="Graphics graphics" %}
* **PageFormat pageFormat**,  {% include w3api/param_description.html metodo=_data parametro="PageFormat pageFormat" %}
