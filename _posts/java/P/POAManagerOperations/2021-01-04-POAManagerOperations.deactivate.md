...
## Parámetros
* **boolean etherealize_objects**,  {% include w3api/param_description.html metodo=_data parametro="boolean etherealize_objects" %}
* **boolean wait_for_completion**,  {% include w3api/param_description.html metodo=_data parametro="boolean wait_for_completion" %}
