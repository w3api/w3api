---
title: PrintService.getServiceUIFactory()
permalink: Java/PrintService-javax-print/getServiceUIFactory
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.P.PrintService-javax-print.metodos valor="getServiceUIFactory" %}
