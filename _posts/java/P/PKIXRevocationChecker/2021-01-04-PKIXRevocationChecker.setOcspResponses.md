...
## Parámetros
* **byte[]&gt; responses**,  {% include w3api/param_description.html metodo=_data parametro="byte[]> responses" %}
* **Map&lt;X509Certificate**,  {% include w3api/param_description.html metodo=_data parametro="Map<X509Certificate" %}
