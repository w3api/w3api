...
## Parámetros
* **byte[] cookie**,  {% include w3api/param_description.html metodo=_data parametro="byte[] cookie" %}
* **int pageSize**,  {% include w3api/param_description.html metodo=_data parametro="int pageSize" %}
