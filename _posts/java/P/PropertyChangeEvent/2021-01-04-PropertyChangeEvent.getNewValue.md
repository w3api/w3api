---
title: PropertyChangeEvent.getNewValue()
permalink: Java/PropertyChangeEvent/getNewValue
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.P.PropertyChangeEvent.metodos valor="getNewValue" %}
