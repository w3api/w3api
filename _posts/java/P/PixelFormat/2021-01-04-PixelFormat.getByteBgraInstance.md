---
title: PixelFormat.getByteBgraInstance()
permalink: Java/PixelFormat/getByteBgraInstance
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.P.PixelFormat.metodos valor="getByteBgraInstance" %}
