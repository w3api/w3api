---
title: PixelFormat.getIntArgbPreInstance()
permalink: Java/PixelFormat/getIntArgbPreInstance
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.P.PixelFormat.metodos valor="getIntArgbPreInstance" %}
