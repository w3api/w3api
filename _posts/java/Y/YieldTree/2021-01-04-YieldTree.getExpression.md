...
{% include w3api/datos.html clase=site.data.Java.Y.YieldTree.metodos valor="getExpression" %}
...
## Líneas de Código
<ul>
{%- for _ldc in site.data.Java.Y.YieldTree.ldc -%}
   <li>
