---
title: WorkerStateEvent.WORKER_STATE_FAILED
...
{% include w3api/datos.html clase=site.data.Java.W.WorkerStateEvent.campos valor="WORKER_STATE_FAILED" %}
...
## Sintaxis
~~~java
static EventType<WorkerStateEvent> WORKER_STATE_FAILED
~~~
