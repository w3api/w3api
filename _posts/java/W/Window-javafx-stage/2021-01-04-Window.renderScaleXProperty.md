---
title: Window.renderScaleXProperty()
permalink: Java/Window-javafx-stage/renderScaleXProperty
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.W.Window-javafx-stage.metodos valor="renderScaleXProperty" %}
