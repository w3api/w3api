---
title: WebSocket.Listener.onPing()
permalink: /Java/WebSocket/Listener/onPing/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.W.WebSocket.Listener.metodos valor="onPing" %}
