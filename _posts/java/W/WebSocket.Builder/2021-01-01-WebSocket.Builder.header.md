---
title: WebSocket.Builder.header()
permalink: /Java/WebSocket/Builder/header/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.W.WebSocket.Builder.metodos valor="header" %}
