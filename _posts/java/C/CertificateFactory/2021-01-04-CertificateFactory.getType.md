---
title: CertificateFactory.getType()
permalink: Java/CertificateFactory/getType
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.CertificateFactory.metodos valor="getType" %}
