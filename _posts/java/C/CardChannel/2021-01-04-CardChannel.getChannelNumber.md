---
title: CardChannel.getChannelNumber()
permalink: Java/CardChannel/getChannelNumber
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.CardChannel.metodos valor="getChannelNumber" %}
