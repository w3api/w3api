...
## Parámetros
* **Collection&lt;?&gt; c2**,  {% include w3api/param_description.html metodo=_data parametro="Collection<?> c2" %}
* **Collection&lt;?&gt; c1**,  {% include w3api/param_description.html metodo=_data parametro="Collection<?> c1" %}
