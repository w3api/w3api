...
## Parámetros
* **Map&lt;E**,  {% include w3api/param_description.html metodo=_data parametro="Map<E" %}
* **Boolean&gt; map**,  {% include w3api/param_description.html metodo=_data parametro="Boolean> map" %}
