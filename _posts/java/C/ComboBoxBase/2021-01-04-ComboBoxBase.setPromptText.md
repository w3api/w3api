---
title: ComboBoxBase.setPromptText()
permalink: Java/ComboBoxBase/setPromptText
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.ComboBoxBase.metodos valor="setPromptText" %}
