...
## Parámetros
* **int controlCode**,  {% include w3api/param_description.html metodo=_data parametro="int controlCode" %}
* **byte[] command**,  {% include w3api/param_description.html metodo=_data parametro="byte[] command" %}

## Excepciones
[CardException](/Java/CardException/), [SecurityException](/Java/SecurityException/), [IllegalStateException](/Java/IllegalStateException/), [NullPointerException](/Java/NullPointerException/)
