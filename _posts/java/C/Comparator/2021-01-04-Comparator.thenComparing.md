...
## Parámetros
* **Comparator&lt;? super U&gt; keyComparator**,  {% include w3api/param_description.html metodo=_data parametro="Comparator<? super U> keyComparator" %}
* **? extends U&gt; keyExtractor**,  {% include w3api/param_description.html metodo=_data parametro="? extends U> keyExtractor" %}
* **Comparator&lt;? super T&gt; other**,  {% include w3api/param_description.html metodo=_data parametro="Comparator<? super T> other" %}
