---
title: CannotProceedHelper.write()
permalink: Java/CannotProceedHelper/write
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.CannotProceedHelper.metodos valor="write" %}
...
## Parámetros
* **CannotProceed value**,  {% include w3api/param_description.html metodo=_data parametro="CannotProceed value" %}
