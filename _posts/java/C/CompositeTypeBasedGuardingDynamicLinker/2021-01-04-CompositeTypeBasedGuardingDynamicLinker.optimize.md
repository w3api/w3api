...
## Parámetros
* **Iterable&lt;? extends GuardingDynamicLinker&gt; linkers**,  {% include w3api/param_description.html metodo=_data parametro="Iterable<? extends GuardingDynamicLinker> linkers" %}
