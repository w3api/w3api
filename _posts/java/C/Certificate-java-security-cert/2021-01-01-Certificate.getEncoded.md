...
permalink: /Java/Certificate-java-security-cert/getEncoded/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.C.Certificate-java-security-cert.metodos valor="getEncoded" %}
