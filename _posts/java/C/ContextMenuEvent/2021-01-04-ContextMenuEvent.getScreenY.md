---
title: ContextMenuEvent.getScreenY()
permalink: Java/ContextMenuEvent/getScreenY
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.ContextMenuEvent.metodos valor="getScreenY" %}
