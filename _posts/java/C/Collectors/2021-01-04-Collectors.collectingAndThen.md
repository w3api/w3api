...
## Parámetros
* **RR&gt; finisher**,  {% include w3api/param_description.html metodo=_data parametro="RR> finisher" %}
* **Collector&lt;T**,  {% include w3api/param_description.html metodo=_data parametro="Collector<T" %}
* **Function&lt;R**,  {% include w3api/param_description.html metodo=_data parametro="Function<R" %}
