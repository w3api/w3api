---
title: CallableStatement.getInt()
permalink: Java/CallableStatement/getInt
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.CallableStatement.metodos valor="getInt" %}
