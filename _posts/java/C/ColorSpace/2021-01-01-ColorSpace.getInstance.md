...
{% include w3api/datos.html clase=site.data.Java.C.ColorSpace.metodos valor="getInstance" %}
...
## Parámetros
* **int colorspace**,  {% include w3api/param_description.html metodo=_dato parametro="int colorspace" %}
