...
## Parámetros
* **U&gt; fn**,  {% include w3api/param_description.html metodo=_data parametro="U> fn" %}
* **CompletionStage&lt;? extends T&gt; other**,  {% include w3api/param_description.html metodo=_data parametro="CompletionStage<? extends T> other" %}
