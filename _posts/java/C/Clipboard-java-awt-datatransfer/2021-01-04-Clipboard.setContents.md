...
## Parámetros
* **Transferable contents**,  {% include w3api/param_description.html metodo=_data parametro="Transferable contents" %}
* **ClipboardOwner owner**,  {% include w3api/param_description.html metodo=_data parametro="ClipboardOwner owner" %}
