...
## Parámetros
* **ContentSignerParameters parameters**,  {% include w3api/param_description.html metodo=_data parametro="ContentSignerParameters parameters" %}
* **boolean applyTimestamp**,  {% include w3api/param_description.html metodo=_data parametro="boolean applyTimestamp" %}
* **boolean omitContent**,  {% include w3api/param_description.html metodo=_data parametro="boolean omitContent" %}
