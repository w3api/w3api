...
{% include w3api/datos.html clase=site.data.Java.C.ColorConverter.metodos valor="getInstance" %}
...
## Clase Padre
[ColorConverter](/Java/ColorConverter/)
...
## Líneas de Código
<ul>
{%- for _ldc in site.data.Java.C.ColorConverter.ldc -%}
   <li>
