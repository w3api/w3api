...
{% include w3api/datos.html clase=site.data.Java.C.Character.UnicodeBlock.campos valor="GEOMETRIC_SHAPES_EXTENDED" %}
...
## Sintaxis
~~~java
static Character.UnicodeBlock GEOMETRIC_SHAPES_EXTENDED
~~~
