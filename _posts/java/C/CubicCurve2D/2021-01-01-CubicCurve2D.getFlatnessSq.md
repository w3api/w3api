---
title: CubicCurve2D.getFlatnessSq()
permalink: /Java/CubicCurve2D/getFlatnessSq/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.C.CubicCurve2D.metodos valor="getFlatnessSq" %}
