...
## Parámetros
* **AWTEvent newEvent**,  {% include w3api/param_description.html metodo=_data parametro="AWTEvent newEvent" %}
* **AWTEvent existingEvent**,  {% include w3api/param_description.html metodo=_data parametro="AWTEvent existingEvent" %}
