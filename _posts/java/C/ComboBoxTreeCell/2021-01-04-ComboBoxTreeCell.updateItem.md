---
title: ComboBoxTreeCell.updateItem()
permalink: Java/ComboBoxTreeCell/updateItem
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.C.ComboBoxTreeCell.metodos valor="updateItem" %}
...
## Parámetros
* **boolean empty**,  {% include w3api/param_description.html metodo=_data parametro="boolean empty" %}
