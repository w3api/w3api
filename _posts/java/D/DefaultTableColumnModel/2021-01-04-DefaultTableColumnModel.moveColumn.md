---
title: DefaultTableColumnModel.moveColumn()
permalink: Java/DefaultTableColumnModel/moveColumn
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DefaultTableColumnModel.metodos valor="moveColumn" %}
...
* **int newIndex**,  {% include w3api/param_description.html metodo=_data parametro="int newIndex" %}
