...
## Descripción
{{site.data.Java.D.DynSequence-org-omg-DynamicAny.description }}
...
## Ejemplo
~~~java
{{ site.data.Java.D.DynSequence-org-omg-DynamicAny.code}}
~~~

## Líneas de Código
<ul>
{%- for _ldc in site.data.Java.D.DynSequence-org-omg-DynamicAny.ldc -%}
   <li>
