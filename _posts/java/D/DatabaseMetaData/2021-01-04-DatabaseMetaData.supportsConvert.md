...
## Parámetros
* **int fromType**,  {% include w3api/param_description.html metodo=_data parametro="int fromType" %}
* **int toType**,  {% include w3api/param_description.html metodo=_data parametro="int toType" %}
