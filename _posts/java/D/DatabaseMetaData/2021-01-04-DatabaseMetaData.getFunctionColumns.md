...
permalink: Java/DatabaseMetaData/getFunctionColumns
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DatabaseMetaData.metodos valor="getFunctionColumns" %}
...
## Parámetros
* **String functionNamePattern**,  {% include w3api/param_description.html metodo=_data parametro="String functionNamePattern" %}
