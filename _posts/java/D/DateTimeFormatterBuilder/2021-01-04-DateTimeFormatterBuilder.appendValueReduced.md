...
## Parámetros
* **int baseValue**,  {% include w3api/param_description.html metodo=_data parametro="int baseValue" %}
...
* **ChronoLocalDate baseDate**,  {% include w3api/param_description.html metodo=_data parametro="ChronoLocalDate baseDate" %}
