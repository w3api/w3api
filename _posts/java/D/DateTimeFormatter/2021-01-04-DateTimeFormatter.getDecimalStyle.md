---
title: DateTimeFormatter.getDecimalStyle()
permalink: Java/DateTimeFormatter/getDecimalStyle
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DateTimeFormatter.metodos valor="getDecimalStyle" %}
