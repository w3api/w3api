---
title: DatatypeConverterInterface.parseLong()
permalink: Java/DatatypeConverterInterface/parseLong
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DatatypeConverterInterface.metodos valor="parseLong" %}
...
## Parámetros
* **String lexicalXSDLong**,  {% include w3api/param_description.html metodo=_data parametro="String lexicalXSDLong" %}
