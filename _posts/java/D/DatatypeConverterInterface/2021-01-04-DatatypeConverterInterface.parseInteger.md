---
title: DatatypeConverterInterface.parseInteger()
permalink: Java/DatatypeConverterInterface/parseInteger
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DatatypeConverterInterface.metodos valor="parseInteger" %}
...
## Parámetros
* **String lexicalXSDInteger**,  {% include w3api/param_description.html metodo=_data parametro="String lexicalXSDInteger" %}
