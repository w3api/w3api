...
## Parámetros
* **BigDecimal factor**,  {% include w3api/param_description.html metodo=_data parametro="BigDecimal factor" %}
* **int factor**,  {% include w3api/param_description.html metodo=_data parametro="int factor" %}
