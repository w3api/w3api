---
title: DirectColorModel.getAlpha()
permalink: Java/DirectColorModel/getAlpha
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.D.DirectColorModel.metodos valor="getAlpha" %}
