---
title: DragGestureRecognizer.getTriggerEvent()
permalink: Java/DragGestureRecognizer/getTriggerEvent
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DragGestureRecognizer.metodos valor="getTriggerEvent" %}
