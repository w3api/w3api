---
title: Desktop.setDefaultMenuBar()
permalink: Java/Desktop/setDefaultMenuBar
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.Desktop.metodos valor="setDefaultMenuBar" %}
...
## Parámetros
* **JMenuBar menuBar**,  {% include w3api/param_description.html metodo=_data parametro="JMenuBar menuBar" %}
