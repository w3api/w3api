---
title: DuplicateNameHelper.write()
permalink: Java/DuplicateNameHelper/write
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DuplicateNameHelper.metodos valor="write" %}
...
## Parámetros
* **DuplicateName value**,  {% include w3api/param_description.html metodo=_data parametro="DuplicateName value" %}
* **OutputStream ostream**,  {% include w3api/param_description.html metodo=_data parametro="OutputStream ostream" %}

## Clase Padre
[DuplicateNameHelper](/Java/DuplicateNameHelper/)
