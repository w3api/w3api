---
title: DynStructHelper.insert()
permalink: Java/DynStructHelper/insert
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.D.DynStructHelper.metodos valor="insert" %}
...
* **DynStruct that**,  {% include w3api/param_description.html metodo=_dato parametro="DynStruct that" %}
