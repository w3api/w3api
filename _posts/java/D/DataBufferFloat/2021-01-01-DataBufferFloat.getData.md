---
title: DataBufferFloat.getData()
permalink: Java/DataBufferFloat/getData
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.D.DataBufferFloat.metodos valor="getData" %}
