---
title: DatatypeConverter.parseDecimal()
permalink: Java/DatatypeConverter/parseDecimal
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.D.DatatypeConverter.metodos valor="parseDecimal" %}
...
## Parámetros
* **String lexicalXSDDecimal**,  {% include w3api/param_description.html metodo=_data parametro="String lexicalXSDDecimal" %}
