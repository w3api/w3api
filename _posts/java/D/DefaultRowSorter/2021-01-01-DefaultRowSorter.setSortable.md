...
{% include w3api/datos.html clase=site.data.Java.D.DefaultRowSorter.metodos valor="setSortable" %}
...
* **boolean sortable**,  {% include w3api/param_description.html metodo=_dato parametro="boolean sortable" %}
