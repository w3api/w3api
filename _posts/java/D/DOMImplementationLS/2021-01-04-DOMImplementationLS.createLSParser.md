...
## Parámetros
* **String schemaType**,  {% include w3api/param_description.html metodo=_data parametro="String schemaType" %}
* **short mode**,  {% include w3api/param_description.html metodo=_data parametro="short mode" %}
