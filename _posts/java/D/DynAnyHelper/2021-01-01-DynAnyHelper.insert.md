---
title: DynAnyHelper.insert()
permalink: /Java/DynAnyHelper/insert/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.D.DynAnyHelper.metodos valor="insert" %}
...
* **DynAny that**,  {% include w3api/param_description.html metodo=_dato parametro="DynAny that" %}
