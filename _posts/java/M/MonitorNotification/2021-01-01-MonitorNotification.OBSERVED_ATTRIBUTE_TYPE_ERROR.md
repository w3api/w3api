---
title: MonitorNotification.OBSERVED_ATTRIBUTE_TYPE_ERROR
...
{% include w3api/datos.html clase=site.data.Java.M.MonitorNotification.campos valor="OBSERVED_ATTRIBUTE_TYPE_ERROR" %}
