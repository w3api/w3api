...
permalink: Java/MethodHandles/varHandleExactInvoker
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.M.MethodHandles.metodos valor="varHandleExactInvoker" %}
...
## Parámetros
* **VarHandle.AccessMode accessMode**,  {% include w3api/param_description.html metodo=_data parametro="VarHandle.AccessMode accessMode" %}
