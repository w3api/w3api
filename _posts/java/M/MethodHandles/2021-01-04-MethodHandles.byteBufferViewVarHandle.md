...
permalink: Java/MethodHandles/byteBufferViewVarHandle
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.M.MethodHandles.metodos valor="byteBufferViewVarHandle" %}
...
## Parámetros
* **Class&lt;?&gt; viewArrayClass**,  {% include w3api/param_description.html metodo=_data parametro="Class<?> viewArrayClass" %}
* **ByteOrder byteOrder**,  {% include w3api/param_description.html metodo=_data parametro="ByteOrder byteOrder" %}
