---
title: MultiPixelPackedSampleModel.setDataElements()
...
{% include w3api/datos.html clase=site.data.Java.M.MultiPixelPackedSampleModel.metodos valor="setDataElements" %}
