...
## Parámetros
* **RoundingMode setRoundingMode**,  {% include w3api/param_description.html metodo=_data parametro="RoundingMode setRoundingMode" %}
* **int setPrecision**,  {% include w3api/param_description.html metodo=_data parametro="int setPrecision" %}
