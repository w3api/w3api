...
permalink: Java/MenuItem-javafx-scene-control/getText
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.M.MenuItem-javafx-scene-control.metodos valor="getText" %}
