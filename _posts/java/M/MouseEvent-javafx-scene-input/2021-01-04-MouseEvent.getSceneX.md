---
title: MouseEvent.getSceneX()
permalink: Java/MouseEvent-javafx-scene-input/getSceneX
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.M.MouseEvent-javafx-scene-input.metodos valor="getSceneX" %}
