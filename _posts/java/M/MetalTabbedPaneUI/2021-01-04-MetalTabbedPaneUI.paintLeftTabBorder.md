---
title: MetalTabbedPaneUI.paintLeftTabBorder()
permalink: Java/MetalTabbedPaneUI/paintLeftTabBorder
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.M.MetalTabbedPaneUI.metodos valor="paintLeftTabBorder" %}
...
* **int rght**,  {% include w3api/param_description.html metodo=_data parametro="int rght" %}
...
* **int btm**,  {% include w3api/param_description.html metodo=_data parametro="int btm" %}
...
## Clase Padre
[MetalTabbedPaneUI](/Java/MetalTabbedPaneUI/)
