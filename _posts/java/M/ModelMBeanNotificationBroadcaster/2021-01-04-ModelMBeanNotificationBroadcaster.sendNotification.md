...
## Parámetros
* **Notification ntfyObj**,  {% include w3api/param_description.html metodo=_data parametro="Notification ntfyObj" %}
* **String ntfyText**,  {% include w3api/param_description.html metodo=_data parametro="String ntfyText" %}
