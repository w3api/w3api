...
## Parámetros
* **StackTraceElement stackFrame**,  {% include w3api/param_description.html metodo=_data parametro="StackTraceElement stackFrame" %}
* **String className**,  {% include w3api/param_description.html metodo=_data parametro="String className" %}
* **int stackDepth**,  {% include w3api/param_description.html metodo=_data parametro="int stackDepth" %}
