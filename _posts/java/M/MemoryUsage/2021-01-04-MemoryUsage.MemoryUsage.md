...
## Parámetros
* **long committed**,  {% include w3api/param_description.html metodo=_data parametro="long committed" %}
* **long init**,  {% include w3api/param_description.html metodo=_data parametro="long init" %}
* **long used**,  {% include w3api/param_description.html metodo=_data parametro="long used" %}
