---
title: MouseEvent.getMouseModifiersText()
permalink: Java/MouseEvent-java-awt-event/getMouseModifiersText
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.M.MouseEvent-java-awt-event.metodos valor="getMouseModifiersText" %}
