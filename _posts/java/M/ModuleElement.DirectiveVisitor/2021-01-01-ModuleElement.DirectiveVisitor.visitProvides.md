...
{% include w3api/datos.html clase=site.data.Java.M.ModuleElement.DirectiveVisitor.metodos valor="visitProvides" %}
...
## Parámetros
* **ModuleElement.ProvidesDirective d**,  {% include w3api/param_description.html metodo=_dato parametro="ModuleElement.ProvidesDirective d" %}
