---
title: ValueDescriptor.getLabel()
permalink: Java/ValueDescriptor/getLabel
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.V.ValueDescriptor.metodos valor="getLabel" %}
