---
title: VarHandle.AccessMode.GET_AND_ADD
permalink: Java/VarHandle/AccessMode/GET_AND_ADD
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.V.VarHandle.AccessMode.enumeraodos valor="GET_AND_ADD" %}
