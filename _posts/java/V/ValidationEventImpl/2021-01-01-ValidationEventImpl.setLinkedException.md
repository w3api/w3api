---
title: ValidationEventImpl.setLinkedException()
permalink: Java/ValidationEventImpl/setLinkedException
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.V.ValidationEventImpl.metodos valor="setLinkedException" %}
