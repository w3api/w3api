---
title: UtilDelegate.getCodebase()
permalink: Java/UtilDelegate/getCodebase
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.U.UtilDelegate.metodos valor="getCodebase" %}
