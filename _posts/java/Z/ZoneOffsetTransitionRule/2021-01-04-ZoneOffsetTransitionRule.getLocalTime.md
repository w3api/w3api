...
permalink: Java/ZoneOffsetTransitionRule/getLocalTime
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.Z.ZoneOffsetTransitionRule.metodos valor="getLocalTime" %}
