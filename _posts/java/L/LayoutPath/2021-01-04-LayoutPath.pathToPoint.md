...
## Parámetros
* **boolean preceding**,  {% include w3api/param_description.html metodo=_data parametro="boolean preceding" %}
* **Point2D location**,  {% include w3api/param_description.html metodo=_data parametro="Point2D location" %}
