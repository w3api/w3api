---
title: LocalDateTime.isSupported()
permalink: /Java/LocalDateTime/isSupported/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.L.LocalDateTime.metodos valor="isSupported" %}
