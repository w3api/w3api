...
## Parámetros
* **LongStream b**,  {% include w3api/param_description.html metodo=_data parametro="LongStream b" %}
* **LongStream a**,  {% include w3api/param_description.html metodo=_data parametro="LongStream a" %}
