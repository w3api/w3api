...
## Parámetros
* **int deletePos**,  {% include w3api/param_description.html metodo=_data parametro="int deletePos" %}
* **AttributedCharacterIterator newParagraph**,  {% include w3api/param_description.html metodo=_data parametro="AttributedCharacterIterator newParagraph" %}
