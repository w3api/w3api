---
title: ListChangeListener.Change.getPermutation()
permalink: Java/ListChangeListener/Change/getPermutation
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.L.ListChangeListener.Change.metodos valor="getPermutation" %}
