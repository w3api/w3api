---
title: LinkedBlockingDeque.removeFirst()
permalink: Java/LinkedBlockingDeque/removeFirst
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.L.LinkedBlockingDeque.metodos valor="removeFirst" %}
