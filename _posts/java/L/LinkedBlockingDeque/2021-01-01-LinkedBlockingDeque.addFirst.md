---
title: LinkedBlockingDeque.addFirst()
permalink: Java/LinkedBlockingDeque/addFirst
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.L.LinkedBlockingDeque.metodos valor="addFirst" %}
