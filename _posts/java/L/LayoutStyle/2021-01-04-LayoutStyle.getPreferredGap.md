...
## Parámetros
* **JComponent component1**,  {% include w3api/param_description.html metodo=_data parametro="JComponent component1" %}
* **LayoutStyle.ComponentPlacement type**,  {% include w3api/param_description.html metodo=_data parametro="LayoutStyle.ComponentPlacement type" %}
...
* **JComponent component2**,  {% include w3api/param_description.html metodo=_data parametro="JComponent component2" %}
