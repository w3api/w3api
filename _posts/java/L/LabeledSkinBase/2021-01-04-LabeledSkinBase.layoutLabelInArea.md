...
{% include w3api/datos.html clase=site.data.Java.L.LabeledSkinBase.metodos valor="layoutLabelInArea" %}
...
## Parámetros
* **Pos alignment**,  {% include w3api/param_description.html metodo=_data parametro="Pos alignment" %}
