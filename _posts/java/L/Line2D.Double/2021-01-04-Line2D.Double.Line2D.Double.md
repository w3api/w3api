---
title: Line2D.Double.Line2D.Double()
permalink: Java/Line2D/Double/Line2D/Double
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.L.Line2D.Double.constructores valor="Line2D.Double" %}
