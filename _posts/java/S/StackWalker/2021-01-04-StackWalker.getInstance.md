...
## Parámetros
* **Set&lt;StackWalker.Option&gt; options**,  {% include w3api/param_description.html metodo=_data parametro="Set<StackWalker.Option> options" %}
* **int estimateDepth**,  {% include w3api/param_description.html metodo=_data parametro="int estimateDepth" %}
* **StackWalker.Option option**,  {% include w3api/param_description.html metodo=_data parametro="StackWalker.Option option" %}
