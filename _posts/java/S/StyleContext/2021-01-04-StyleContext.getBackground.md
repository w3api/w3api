---
title: StyleContext.getBackground()
permalink: Java/StyleContext/getBackground
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.StyleContext.metodos valor="getBackground" %}
