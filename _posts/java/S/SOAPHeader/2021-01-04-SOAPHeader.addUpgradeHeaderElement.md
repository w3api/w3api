...
## Parámetros
* **String supportedSoapUri**,  {% include w3api/param_description.html metodo=_data parametro="String supportedSoapUri" %}
* **String[] supportedSoapUris**,  {% include w3api/param_description.html metodo=_data parametro="String[] supportedSoapUris" %}
* **Iterator&lt;String&gt; supportedSOAPURIs**,  {% include w3api/param_description.html metodo=_data parametro="Iterator<String> supportedSOAPURIs" %}
