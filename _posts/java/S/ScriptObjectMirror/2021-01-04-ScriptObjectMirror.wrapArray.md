---
title: ScriptObjectMirror.wrapArray()
permalink: Java/ScriptObjectMirror/wrapArray
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.ScriptObjectMirror.metodos valor="wrapArray" %}
...
## Parámetros
* **Object homeGlobal**,  {% include w3api/param_description.html metodo=_data parametro="Object homeGlobal" %}
