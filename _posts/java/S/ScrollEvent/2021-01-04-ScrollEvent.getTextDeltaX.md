---
title: ScrollEvent.getTextDeltaX()
permalink: Java/ScrollEvent/getTextDeltaX
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.ScrollEvent.metodos valor="getTextDeltaX" %}
