---
title: ScrollEvent.getTextDeltaXUnits()
permalink: Java/ScrollEvent/getTextDeltaXUnits
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.ScrollEvent.metodos valor="getTextDeltaXUnits" %}
