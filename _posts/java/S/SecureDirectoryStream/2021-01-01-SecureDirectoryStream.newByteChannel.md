...
permalink: Java/SecureDirectoryStream/newByteChannel
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SecureDirectoryStream.metodos valor="newByteChannel" %}
...
## Excepciones
[IllegalArgumentException](/Java/IllegalArgumentException/), [FileAlreadyExistsException](/Java/FileAlreadyExistsException/), [IOException](/Java/IOException/), [ClosedDirectoryStreamException](/Java/ClosedDirectoryStreamException/), [SecurityException](/Java/SecurityException/), [UnsupportedOperationException](/Java/UnsupportedOperationException/)
