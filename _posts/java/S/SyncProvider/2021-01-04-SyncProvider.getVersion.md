---
title: SyncProvider.getVersion()
permalink: Java/SyncProvider/getVersion
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SyncProvider.metodos valor="getVersion" %}
