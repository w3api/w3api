---
title: ScheduledService.getCurrentFailureCount()
permalink: Java/ScheduledService/getCurrentFailureCount
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.ScheduledService.metodos valor="getCurrentFailureCount" %}
