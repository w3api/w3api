---
title: ScheduledService.getBackoffStrategy()
permalink: Java/ScheduledService/getBackoffStrategy
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.ScheduledService.metodos valor="getBackoffStrategy" %}
