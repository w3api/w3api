---
title: SSLParameters.setProtocols()
permalink: Java/SSLParameters/setProtocols
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SSLParameters.metodos valor="setProtocols" %}
