...
## Parámetros
* **boolean block**,  {% include w3api/param_description.html metodo=_data parametro="boolean block" %}

## Excepciones
[ClosedChannelException](/Java/ClosedChannelException/), [IllegalBlockingModeException](/Java/IllegalBlockingModeException/), [IOException](/Java/IOException/)
