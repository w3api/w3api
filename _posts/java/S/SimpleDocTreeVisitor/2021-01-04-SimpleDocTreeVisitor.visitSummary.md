---
title: SimpleDocTreeVisitor.visitSummary()
permalink: Java/SimpleDocTreeVisitor/visitSummary
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitSummary" %}
...
* **SummaryTree node**,  {% include w3api/param_description.html metodo=_data parametro="SummaryTree node" %}
