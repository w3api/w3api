---
title: SimpleDocTreeVisitor.visitComment()
permalink: Java/SimpleDocTreeVisitor/visitComment
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitComment" %}
...
* **CommentTree node**,  {% include w3api/param_description.html metodo=_data parametro="CommentTree node" %}
