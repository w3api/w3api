---
title: SimpleDocTreeVisitor.visitIndex()
permalink: Java/SimpleDocTreeVisitor/visitIndex
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitIndex" %}
...
* **IndexTree node**,  {% include w3api/param_description.html metodo=_data parametro="IndexTree node" %}
