---
title: SimpleDocTreeVisitor.visitDocRoot()
permalink: Java/SimpleDocTreeVisitor/visitDocRoot
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitDocRoot" %}
...
* **DocRootTree node**,  {% include w3api/param_description.html metodo=_data parametro="DocRootTree node" %}
