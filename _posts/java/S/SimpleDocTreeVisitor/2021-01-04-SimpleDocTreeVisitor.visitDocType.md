---
title: SimpleDocTreeVisitor.visitDocType()
permalink: Java/SimpleDocTreeVisitor/visitDocType
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitDocType" %}
...
* **DocTypeTree node**,  {% include w3api/param_description.html metodo=_data parametro="DocTypeTree node" %}
