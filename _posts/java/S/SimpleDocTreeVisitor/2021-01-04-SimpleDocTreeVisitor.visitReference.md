---
title: SimpleDocTreeVisitor.visitReference()
permalink: Java/SimpleDocTreeVisitor/visitReference
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitReference" %}
...
* **ReferenceTree node**,  {% include w3api/param_description.html metodo=_data parametro="ReferenceTree node" %}
