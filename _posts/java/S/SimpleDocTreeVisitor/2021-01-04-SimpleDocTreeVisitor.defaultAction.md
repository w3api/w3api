---
title: SimpleDocTreeVisitor.defaultAction()
permalink: Java/SimpleDocTreeVisitor/defaultAction
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="defaultAction" %}
...
* **DocTree node**,  {% include w3api/param_description.html metodo=_data parametro="DocTree node" %}
