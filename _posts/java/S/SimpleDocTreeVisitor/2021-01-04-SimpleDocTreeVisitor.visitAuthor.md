---
title: SimpleDocTreeVisitor.visitAuthor()
permalink: Java/SimpleDocTreeVisitor/visitAuthor
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitAuthor" %}
...
* **AuthorTree node**,  {% include w3api/param_description.html metodo=_data parametro="AuthorTree node" %}
