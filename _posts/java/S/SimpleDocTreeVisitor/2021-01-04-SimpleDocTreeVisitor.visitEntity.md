---
title: SimpleDocTreeVisitor.visitEntity()
permalink: Java/SimpleDocTreeVisitor/visitEntity
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SimpleDocTreeVisitor.metodos valor="visitEntity" %}
...
* **EntityTree node**,  {% include w3api/param_description.html metodo=_data parametro="EntityTree node" %}
