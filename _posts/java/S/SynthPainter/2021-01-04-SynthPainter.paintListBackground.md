---
title: SynthPainter.paintListBackground()
permalink: Java/SynthPainter/paintListBackground
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SynthPainter.metodos valor="paintListBackground" %}
