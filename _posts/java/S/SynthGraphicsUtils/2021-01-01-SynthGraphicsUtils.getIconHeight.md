---
title: SynthGraphicsUtils.getIconHeight()
permalink: /Java/SynthGraphicsUtils/getIconHeight/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SynthGraphicsUtils.metodos valor="getIconHeight" %}
