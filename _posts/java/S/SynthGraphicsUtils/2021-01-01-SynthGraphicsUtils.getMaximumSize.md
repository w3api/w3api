---
title: SynthGraphicsUtils.getMaximumSize()
permalink: Java/SynthGraphicsUtils/getMaximumSize
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SynthGraphicsUtils.metodos valor="getMaximumSize" %}
