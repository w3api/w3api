---
title: SynthSliderUI.paintThumb()
permalink: Java/SynthSliderUI/paintThumb
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SynthSliderUI.metodos valor="paintThumb" %}
...
* **Rectangle thumbBounds**,  {% include w3api/param_description.html metodo=_data parametro="Rectangle thumbBounds" %}
