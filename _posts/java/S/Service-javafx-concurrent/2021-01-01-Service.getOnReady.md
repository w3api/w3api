---
title: Service.getOnReady()
permalink: Java/Service-javafx-concurrent/getOnReady
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.Service-javafx-concurrent.metodos valor="getOnReady" %}
