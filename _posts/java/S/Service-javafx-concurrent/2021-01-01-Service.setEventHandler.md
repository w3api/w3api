---
title: Service.setEventHandler()
permalink: Java/Service-javafx-concurrent/setEventHandler
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.Service-javafx-concurrent.metodos valor="setEventHandler" %}
