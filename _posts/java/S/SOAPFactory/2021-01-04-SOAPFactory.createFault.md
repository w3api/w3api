...
## Parámetros
* **String reasonText**,  {% include w3api/param_description.html metodo=_data parametro="String reasonText" %}
* **QName faultCode**,  {% include w3api/param_description.html metodo=_data parametro="QName faultCode" %}
