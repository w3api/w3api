---
title: SynthInternalFrameUI.update()
permalink: Java/SynthInternalFrameUI/update
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SynthInternalFrameUI.metodos valor="update" %}
