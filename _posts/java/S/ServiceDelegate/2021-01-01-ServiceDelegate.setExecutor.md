---
title: ServiceDelegate.setExecutor()
permalink: /Java/ServiceDelegate/setExecutor/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.ServiceDelegate.metodos valor="setExecutor" %}
