---
title: SyncResolver.previousConflict()
permalink: Java/SyncResolver/previousConflict
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SyncResolver.metodos valor="previousConflict" %}
