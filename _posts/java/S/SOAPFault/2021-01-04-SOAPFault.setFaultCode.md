...
## Parámetros
* **QName faultCodeQName**,  {% include w3api/param_description.html metodo=_data parametro="QName faultCodeQName" %}
* **Name faultCodeQName**,  {% include w3api/param_description.html metodo=_data parametro="Name faultCodeQName" %}
* **String faultCode**,  {% include w3api/param_description.html metodo=_data parametro="String faultCode" %}
