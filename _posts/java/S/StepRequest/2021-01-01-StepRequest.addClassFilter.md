---
title: StepRequest.addClassFilter()
permalink: /Java/StepRequest/addClassFilter/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.StepRequest.metodos valor="addClassFilter" %}
