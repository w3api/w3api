---
title: SynthStyle.getBoolean()
permalink: Java/SynthStyle/getBoolean
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.S.SynthStyle.metodos valor="getBoolean" %}
...
## Parámetros
* **boolean defaultValue**,  {% include w3api/param_description.html metodo=_data parametro="boolean defaultValue" %}
