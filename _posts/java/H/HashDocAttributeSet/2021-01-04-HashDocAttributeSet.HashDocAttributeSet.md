...
{% include w3api/datos.html clase=site.data.Java.H.HashDocAttributeSet.constructores valor="HashDocAttributeSet" %}
...
* **DocAttribute[] attributes**,  {% include w3api/param_description.html metodo=_data parametro="DocAttribute[] attributes" %}
* **DocAttribute attribute**,  {% include w3api/param_description.html metodo=_data parametro="DocAttribute attribute" %}

## Excepciones
[ClassCastException](/Java/ClassCastException/), [NullPointerException](/Java/NullPointerException/)

## Clase Padre
[HashDocAttributeSet](/Java/HashDocAttributeSet/)
...
## Líneas de Código
<ul>
{%- for _ldc in site.data.Java.H.HashDocAttributeSet.ldc -%}
   <li>
