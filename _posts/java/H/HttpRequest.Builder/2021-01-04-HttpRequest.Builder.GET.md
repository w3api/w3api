---
title: HttpRequest.Builder.GET()
permalink: Java/HttpRequest/Builder/GET
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.H.HttpRequest.Builder.metodos valor="GET" %}
