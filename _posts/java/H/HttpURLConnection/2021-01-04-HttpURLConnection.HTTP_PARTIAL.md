---
title: HttpURLConnection.HTTP_PARTIAL
permalink: Java/HttpURLConnection/HTTP_PARTIAL
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.H.HttpURLConnection.campos valor="HTTP_PARTIAL" %}
