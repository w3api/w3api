---
title: HttpURLConnection.HTTP_RESET
permalink: Java/HttpURLConnection/HTTP_RESET
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.H.HttpURLConnection.campos valor="HTTP_RESET" %}
