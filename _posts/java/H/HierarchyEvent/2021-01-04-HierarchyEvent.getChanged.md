---
title: HierarchyEvent.getChanged()
permalink: Java/HierarchyEvent/getChanged
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.H.HierarchyEvent.metodos valor="getChanged" %}
