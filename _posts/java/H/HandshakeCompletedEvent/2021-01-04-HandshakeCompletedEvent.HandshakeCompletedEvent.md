...
## Parámetros
* **SSLSession s**,  {% include w3api/param_description.html metodo=_data parametro="SSLSession s" %}
* **SSLSocket sock**,  {% include w3api/param_description.html metodo=_data parametro="SSLSocket sock" %}
