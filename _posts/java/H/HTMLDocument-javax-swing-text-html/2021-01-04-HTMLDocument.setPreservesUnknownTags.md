...
{% include w3api/datos.html clase=site.data.Java.H.HTMLDocument-javax-swing-text-html.metodos valor="setPreservesUnknownTags" %}
...
## Parámetros
* **boolean preservesTags**,  {% include w3api/param_description.html metodo=_data parametro="boolean preservesTags" %}
