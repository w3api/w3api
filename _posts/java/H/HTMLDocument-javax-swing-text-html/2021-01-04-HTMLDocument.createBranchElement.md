---
title: HTMLDocument.createBranchElement()
permalink: Java/HTMLDocument-javax-swing-text-html/createBranchElement
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.H.HTMLDocument-javax-swing-text-html.metodos valor="createBranchElement" %}
...
## Parámetros
* **Element parent**,  {% include w3api/param_description.html metodo=_data parametro="Element parent" %}
