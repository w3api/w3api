...
{% include w3api/datos.html clase=site.data.Java.H.HTMLObjectElement.metodos valor="setDeclare" %}
...
## Parámetros
* **boolean declare**,  {% include w3api/param_description.html metodo=_data parametro="boolean declare" %}
