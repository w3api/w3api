...
{% include w3api/datos.html clase=site.data.Java.H.HTMLEditorSkin.constructores valor="HTMLEditorSkin" %}
...
## Parámetros
* **HTMLEditor control**,  {% include w3api/param_description.html metodo=_data parametro="HTMLEditor control" %}
