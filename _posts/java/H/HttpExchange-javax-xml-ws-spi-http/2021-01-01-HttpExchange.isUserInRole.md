...
{% include w3api/datos.html clase=site.data.Java.H.HttpExchange-javax-xml-ws-spi-http.metodos valor="isUserInRole" %}
...
## Parámetros
* **String role**,  {% include w3api/param_description.html metodo=_dato parametro="String role" %}
