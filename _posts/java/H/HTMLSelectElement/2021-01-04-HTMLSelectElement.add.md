...
## Parámetros
* **HTMLElement element**,  {% include w3api/param_description.html metodo=_data parametro="HTMLElement element" %}
* **HTMLElement before**,  {% include w3api/param_description.html metodo=_data parametro="HTMLElement before" %}
