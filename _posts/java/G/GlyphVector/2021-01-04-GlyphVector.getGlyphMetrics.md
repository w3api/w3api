---
title: GlyphVector.getGlyphMetrics()
permalink: Java/GlyphVector/getGlyphMetrics
date: 2021-01-04
...
{% include w3api/datos.html clase=site.data.Java.G.GlyphVector.metodos valor="getGlyphMetrics" %}
