---
title: GlyphView.getNextVisualPositionFrom()
permalink: Java/GlyphView/getNextVisualPositionFrom
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.G.GlyphView.metodos valor="getNextVisualPositionFrom" %}
