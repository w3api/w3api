---
title: GridPane.setColumnIndex()
permalink: Java/GridPane/setColumnIndex
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.G.GridPane.metodos valor="setColumnIndex" %}
...
## Parámetros
* **Integer value**,  {% include w3api/param_description.html metodo=_dato parametro="Integer value" %}
