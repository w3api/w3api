---
title: GraphicsContext.quadraticCurveTo()
permalink: Java/GraphicsContext/quadraticCurveTo
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.G.GraphicsContext.metodos valor="quadraticCurveTo" %}
...
* **double xc**,  {% include w3api/param_description.html metodo=_dato parametro="double xc" %}
* **double y1**,  {% include w3api/param_description.html metodo=_dato parametro="double y1" %}
* **double yc**,  {% include w3api/param_description.html metodo=_dato parametro="double yc" %}
