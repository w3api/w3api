---
title: GlyphView.GlyphPainter.getSpan()
permalink: Java/GlyphView/GlyphPainter/getSpan
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.G.GlyphView.GlyphPainter.metodos valor="getSpan" %}
