...
## Parámetros
* **MethodHandle newGuard**,  {% include w3api/param_description.html metodo=_data parametro="MethodHandle newGuard" %}
* **MethodHandle newInvocation**,  {% include w3api/param_description.html metodo=_data parametro="MethodHandle newInvocation" %}
