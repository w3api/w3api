---
title: GarbageCollectionNotificationInfo.from()
permalink: Java/GarbageCollectionNotificationInfo/from
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.G.GarbageCollectionNotificationInfo.metodos valor="from" %}
