...
## Parámetros
* **int maxTokenSize**,  {% include w3api/param_description.html metodo=_data parametro="int maxTokenSize" %}
* **boolean confReq**,  {% include w3api/param_description.html metodo=_data parametro="boolean confReq" %}
