---
title: BasicTabbedPaneUI.paintContentBorderBottomEdge()
permalink: /Java/BasicTabbedPaneUI/paintContentBorderBottomEdge/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.B.BasicTabbedPaneUI.metodos valor="paintContentBorderBottomEdge" %}
...
## Parámetros
* **int selectedIndex**,  {% include w3api/param_description.html metodo=_dato parametro="int selectedIndex" %}
