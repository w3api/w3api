...
permalink: /Java/Authenticator-java-net/getRequestingProtocol/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.A.Authenticator-java-net.metodos valor="getRequestingProtocol" %}
