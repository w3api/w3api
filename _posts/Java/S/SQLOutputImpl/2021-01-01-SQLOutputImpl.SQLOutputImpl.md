---
title: SQLOutputImpl.SQLOutputImpl()
permalink: /Java/SQLOutputImpl/SQLOutputImpl/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SQLOutputImpl.constructores valor="SQLOutputImpl" %}
...
## Parámetros
* **Vector&lt;?&gt; attributes**,  {% include w3api/param_description.html metodo=_dato parametro="Vector<?> attributes" %}
