---
title: Shape.setStrokeDashOffset()
permalink: /Java/Shape-javafx-scene-shape/setStrokeDashOffset/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.Shape-javafx-scene-shape.metodos valor="setStrokeDashOffset" %}
