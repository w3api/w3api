...
{% include w3api/datos.html clase=site.data.Java.C.CellRendererPane.metodos valor="addImpl" %}
...
## Parámetros
* **Component x**,  {% include w3api/param_description.html metodo=_dato parametro="Component x" %}
