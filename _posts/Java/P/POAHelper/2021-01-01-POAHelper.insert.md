...
{% include w3api/datos.html clase=site.data.Java.P.POAHelper.metodos valor="insert" %}
...
## Sintaxis
~~~java
public static void insert(Any a, POA that)
~~~

## Parámetros
* **Any a**,  {% include w3api/param_description.html metodo=_dato parametro="Any a" %}
* **POA that**,  {% include w3api/param_description.html metodo=_dato parametro="POA that" %}
