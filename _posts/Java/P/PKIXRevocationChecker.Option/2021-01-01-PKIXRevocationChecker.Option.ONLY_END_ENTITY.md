---
title: PKIXRevocationChecker.Option.ONLY_END_ENTITY
...
{% include w3api/datos.html clase=site.data.Java.P.PKIXRevocationChecker.Option.enumeraodos valor="ONLY_END_ENTITY" %}
