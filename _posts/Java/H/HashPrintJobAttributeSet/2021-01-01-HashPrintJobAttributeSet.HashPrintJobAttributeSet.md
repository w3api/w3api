...
{% include w3api/datos.html clase=site.data.Java.H.HashPrintJobAttributeSet.constructores valor="HashPrintJobAttributeSet" %}
...
## Parámetros
* **PrintJobAttribute[] attributes**,  {% include w3api/param_description.html metodo=_dato parametro="PrintJobAttribute[] attributes" %}
* **PrintJobAttribute attribute**,  {% include w3api/param_description.html metodo=_dato parametro="PrintJobAttribute attribute" %}
...
## Clase Padre
[HashPrintJobAttributeSet](/Java/HashPrintJobAttributeSet/)
