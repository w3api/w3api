---
title: MenuItem.setId()
permalink: /Java/MenuItem-javafx-scene-control/setId/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.M.MenuItem-javafx-scene-control.metodos valor="setId" %}
