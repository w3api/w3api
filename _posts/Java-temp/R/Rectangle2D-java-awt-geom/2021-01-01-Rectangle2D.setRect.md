---
title: Rectangle2D.setRect()
permalink: /Java/Rectangle2D-java-awt-geom/setRect/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.R.Rectangle2D-java-awt-geom.metodos valor="setRect" %}
