...
{% include w3api/datos.html clase=site.data.Java.B.BeanContextServiceRevokedEvent.constructores valor="BeanContextServiceRevokedEvent" %}
...
## Parámetros
* **boolean invalidate**,  {% include w3api/param_description.html metodo=_dato parametro="boolean invalidate" %}
* **Class&lt;?&gt; sc**,  {% include w3api/param_description.html metodo=_dato parametro="Class<?> sc" %}
* **BeanContextServices bcs**,  {% include w3api/param_description.html metodo=_dato parametro="BeanContextServices bcs" %}

## Clase Padre
[BeanContextServiceRevokedEvent](/Java/BeanContextServiceRevokedEvent/)
