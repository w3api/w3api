...
## Parámetros
* **WritableImage wimg**,  {% include w3api/param_description.html metodo=_dato parametro="WritableImage wimg" %}
* **BufferedImage bimg**,  {% include w3api/param_description.html metodo=_dato parametro="BufferedImage bimg" %}
