---
title: SynthGraphicsUtils.getIconWidth()
permalink: /Java/SynthGraphicsUtils/getIconWidth/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SynthGraphicsUtils.metodos valor="getIconWidth" %}
