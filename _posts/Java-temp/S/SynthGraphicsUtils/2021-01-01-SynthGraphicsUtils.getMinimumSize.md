---
title: SynthGraphicsUtils.getMinimumSize()
permalink: /Java/SynthGraphicsUtils/getMinimumSize/
date: 2021-01-11
...
{% include w3api/datos.html clase=site.data.Java.S.SynthGraphicsUtils.metodos valor="getMinimumSize" %}
